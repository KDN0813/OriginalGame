...
void AnimatedControlInstancedModelComponent::PlayAnimation(const AnimeState& animation_info)
{
    this->param.current_animation_seconds = 0;;
...
void AnimatedControlInstancedModelComponent::UpdateAnimationState()
{
#ifdef _DEBUG
...
void AnimatedControlInstancedModelComponent::SetAnimationState(AnimeIndex anime_index, bool loop, float transition_ready_time)
{
...
void AnimatedControlInstancedModelComponent::AddAnimationTransition(AnimeIndex anime_index, AnimeIndex transition_anime_index, std::unique_ptr<TransitionJudgementBase> judgement)
{
...
bool AnimatedControlInstancedModelComponent::IsTransitionReady()
{
    // 再生中でなければ準備完了
...
bool AnimatedControlInstancedModelComponent::PerformTransitionJudgement(TransitionJudgementBase* judgemen)
{
...
void AnimatedControlInstancedModelComponent::DrawDetail()
{
