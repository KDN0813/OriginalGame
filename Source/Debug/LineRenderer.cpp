...
void LineRenderer::Render()
{
	...
	// 定数バッファ更新
	DirectX::XMFLOAT4X4 view = camera_manager->GetCurrentCamera()->GetViewTransform();
	DirectX::XMFLOAT4X4 projection = camera_manager->GetCurrentCamera()->GetProjectionTransform();
