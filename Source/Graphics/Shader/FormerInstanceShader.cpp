...
FormerInstanceShader::FormerInstanceShader(ID3D11Device* device)
	:instancing_count(0)
{
	// 頂点シェーダー
	{
...
void FormerInstanceShader::Begin(ID3D11DeviceContext* dc, const RenderContext& rc)
{
...
void FormerInstanceShader::Draw(ID3D11DeviceContext* dc, InstancingModel* model)
{
...
// サブセット単位で描画
void FormerInstanceShader::DrawSubset(ID3D11DeviceContext* dc, const ModelResource::Subset& subset)
{
...
// 描画
void FormerInstanceShader::End(ID3D11DeviceContext* dc)
{
	{
		instancing_count = 0;
